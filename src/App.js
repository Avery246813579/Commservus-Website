  ...
  render() {
    return (
      ...
      <div className="Login-Bar">
        <button className="Login-Buttons" onClick={this.togglePopup.bind(this)}> Login </button>
        <button className="Login-Buttons" onClick={this.togglePopup.bind(this)}> Sign up </button>
      </div>
